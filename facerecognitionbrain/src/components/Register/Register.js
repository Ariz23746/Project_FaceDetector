...
const Register = ({ onRouteChange }) => {
  return (
  	<article className="br3 shadow-5 ba dark-gray b--black-10 mv4 w-100 w-50-m w-30-l mw6 center">
		  ...
		  <div className="measure">
		    <fieldset id="sign_up" className="ba b--transparent ph0 mh0">
		      ...
		      <div className="mt3">
		        ...
		        <input className="pa2 input-reset ba bg-transparent hover-bg-black hover-white w-120" type="Name" name="Name"  id="Name" />
		      </div>
		      <div className="mt3">
